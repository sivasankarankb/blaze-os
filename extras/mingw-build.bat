...
rem MinGW-w64 Build Script for Blaze OS v0.2.1
set CFILECOUNT=7
set CFLAGS=-c -I include/ -m32 -nostdinc -nostdlib -ffreestanding -march=i386 -fleading-underscore
...
ld obj\kern32.o obj\libk.a -T linker.ld -mi386pe -o obj\ldkern.o
